...
alertas <- alertas %>%
  mutate(flag_duration_mas = if_else(duration_minutes >= 150,0,flag_duration_mas))
...
alertas$nombre_encuestador_str <- factor(alertas$id_encuestador, levels = c(1:15), labels = names(encuestador_labels))
